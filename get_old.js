...
const json = cp.execSync('git show 80e739d:backend/n8n/workflows/ecencia_telegram_menu_reservas.workflow.json').toString();
...
const newJson = require('fs').readFileSync('backend/n8n/workflows/ecencia_telegram_menu_reservas.workflow.json', 'utf8');
