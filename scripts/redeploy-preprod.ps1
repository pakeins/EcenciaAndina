...
Invoke-Step "Construir imagen frontend" {
  gcloud builds submit frontend `
    ...
    --substitutions "_PROJECT_ID=$ProjectId,_REGION=$Region,_REPO=$Repository,_TAG=$Tag,_VITE_API_BASE_URL=$backendUrl/api,_VITE_SUPABASE_URL=$supabaseUrl,_VITE_SUPABASE_PUBLISHABLE_KEY=$publishableKey,_VITE_SUPABASE_PROJECT_ID=$supabaseProjectRef"
}
